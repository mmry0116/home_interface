    ...
    !function(e, t) {
      ...
      return function(e) {
        ...
        Object.defineProperty(t, "__esModule", { value: true }), t.createDom = function() {
          ...
          var n2 = this, i2 = 0;
          return function() {
            for (var r2 = arguments.length, o2 = Array(r2), a2 = 0; a2 < r2; a2++)
              o2[a2] = arguments[a2];
        ...
        var r = "undefined" != typeof window && window.location.href.indexOf("danmu-debug") > -1, o = function() {
          ...
          return i(e2, [{ key: "info", value: function(e3) {
            for (var t2, n2 = arguments.length, i2 = Array(n2 > 1 ? n2 - 1 : 0), o2 = 1; o2 < n2; o2++)
        ...
        var d = t.DanmuJs = function(e2) {
          function t2(e3) {
            ...
            }), n2.container = i2.container && 1 === i2.container.nodeType ? i2.container : null, !n2.container)
              return n2.emit("error", "container id can't be empty"), false, h(n2, false);
          ...
          return function(e3, t3) {
            ...
            for (var e3 in (0, u.unObserver)(this.container), this.logger && this.logger.info("destroy"), this.stop(), this.bulletBtn && this.bulletBtn.destroy(), this.recycler && this.recycler.destroy(), this)
              delete this[e3];
            this.emit("destroy");
            ...
            if (this.logger && this.logger.info("restartComment: id " + e3), e3) {
              var t3 = this.main;
              if (this._releaseCtrl(e3), "closed" === t3.status)
                return;
        ...
        r = function(e2, t2) {
          ...
          var n2, i2, r2, o2;
          if (f(t2), !m.call(this, "__ee__"))
            return this;
          if (!(n2 = this.__ee__)[e2])
            return this;
          if ("object" == typeof (i2 = n2[e2]))
            for (o2 = 0; r2 = i2[o2]; ++o2)
              r2 !== t2 && r2.__eeOnceListener__ !== t2 || (2 === i2.length ? n2[e2] = i2[o2 ? 0 : 1] : i2.splice(o2, 1));
          else
            i2 !== t2 && i2.__eeOnceListener__ !== t2 || delete n2[e2];
          return this;
        }, emit: a = function(e2) {
          var t2, n2, i2, r2, o2;
          if (m.call(this, "__ee__") && (r2 = this.__ee__[e2]))
            if ("object" == typeof r2) {
              for (n2 = arguments.length, o2 = new Array(n2 - 1), t2 = 1; t2 < n2; ++t2)
                o2[t2 - 1] = arguments[t2];
              for (r2 = r2.slice(), t2 = 0; i2 = r2[t2]; ++t2)
                h.call(i2, this, o2);
            } else
        ...
        var u = function(e2) {
          ...
          return function(e3, t3) {
            ...
            for (var e3 in this.logger && this.logger.info("destroy"), this._unbindEvents(), this._cancelTick(), this.channel && this.channel.destroy(), this.data = [], this)
              delete this[e3];
            ...
            if (e3.isReady && e3.main) {
              if (i2) {
                ...
                0 === (a2 = this.data.splice(0, 1)).length && (a2 = this.playedData.splice(0, 1));
              if (a2.length > 0 && n2.checkAvailableTrack(a2[0].mode)) {
                n2.updatePos();
                var u2 = 0;
                e:
                  for (var c, f = 0; f < a2.length; f++)
                    if (c = a2[f], this.forceDuration && this.forceDuration !== c.duration && (c.duration = this.forceDuration), (r2 = new o.default(e3, c)).bulletCreateFail) {
                      if (0 === u2)
                        break e;
                      u2--;
                    } else if (r2.attach(), c.attached_ = true, n2.addBullet(r2).result)
                      this.queue.push(r2), r2.topInit(), u2 = 0;
                    else {
                      for (var h in r2.detach(), r2)
                        s.hasOwnProperty.call(r2, h) && delete r2[h];
                      if (r2 = null, c.attached_ = false, c.noDiscard && (c.prior ? this.data.unshift(c) : this.data.push(c)), 0 === u2)
                        break e;
                      u2--;
                    }
              }
            ...
            if ("number" == typeof t3.maxCommentsLength && i2.length > t3.maxCommentsLength) {
              ...
              for (var a2, s2 = 0; s2 < o2; s2++)
                (a2 = i2[s2]).prior && !a2.attached_ && r2.push(i2[s2]);
            } else if (t3.dropStaleComments && n2 && n2.currentTime) {
              var l2 = Math.floor(1e3 * n2.currentTime) - t3.interval;
              if (l2 > 0) {
                for (var u2, c = 0; c < i2.length; c++)
                  if ((u2 = i2[c]).prior && !u2.attached_ && r2.push(i2[c]), u2.start > l2) {
                    o2 = c;
                    break;
                  }
              }
            ...
            for (var t3, n2 = e3.target || e3.srcElement, i2 = this.queue, r2 = void 0, o2 = 0; o2 < i2.length; o2++)
              if ((t3 = i2[o2]) && t3.el && (t3.el === n2 || t3.el.contains(n2))) {
                r2 = t3;
                break;
              }
            return r2;
          ...
          return function(e3, t3) {
            ...
            if (s2.perspective = "500em", t3.el || t3.elLazyInit) {
              if (this.noCopyEl && (this.reuseDOM = false), t3.elLazyInit) {
                if ((0, a.isFunction)(i2.bulletCreateEl))
                  try {
                    var l2 = i2.bulletCreateEl(t3);
                    r2 = l2 instanceof HTMLElement ? l2 : l2.el;
                  } catch (e4) {
                  }
              } else if (1 === t3.el.nodeType && !t3.el.parentNode)
                if (this.reuseDOM) {
              ...
              "string" == typeof t3.txt && ((r2 = this.recycler.use()).textContent = t3.txt);
            if (!r2 || !e3.main)
              return false;
            var c2 = void 0;
            if ((0, a.isNumber)(n2.bulletOffset) && n2.bulletOffset >= 0)
              c2 = n2.bulletOffset;
            else {
            ...
            if ("paused" !== t3.status && ("forcedPause" !== t3.status && (this.status = "paused"), t3._moveV = void 0, this.el))
              if ("scroll" === this.mode) {
                ...
                if (e3) {
                  ...
                  "b2t" === this.direction ? (0, a.styleUtil)(this.el, "transform", "translateX(-" + this.top + "px) translateY(" + (this.el.getBoundingClientRect().top - n2.top) + "px) translateZ(0px) rotate(90deg)") : (0, a.styleUtil)(this.el, "left", this.el.getBoundingClientRect().left - n2.left + "px");
                ...
                this.pastDuration && this.startTime ? this.pastDuration = this.pastDuration + (/* @__PURE__ */ new Date()).getTime() - this.startTime : this.pastDuration = 1;
          } }, { key: "startMove", value: function(e3) {
            if (this.hasMove || (this.danmu.emit("bullet_start", this), this.hasMove = true), ("forcedPause" !== this.status || e3) && this.el && "start" !== this.status)
        ...
        var u = function(e2) {
          ...
          return function(e3, t3) {
            ...
            if ("scroll" === e3)
              for (var i2, r2 = 0; r2 < t3.length; r2++)
                if (n2 = true, (i2 = t3[r2]).operating[e3])
                  n2 = false;
                else {
            ...
            if ("b2t" === t3.direction ? (o2 = this.channelWidth, a2 = Math.ceil(e3.width / o2)) : (r2 = this.channelHeight, a2 = Math.ceil(e3.height / r2)), a2 > i2.length)
            ...
            if ("scroll" === e3.mode)
              for (var h = 0, d = i2.length - a2; h <= d; h += a2) {
                s2 = true;
              ...
              for (var x = 0, E = i2.length - a2; x <= E; x++) {
                s2 = true;
            ...
            if (-1 !== u2) {
              for (var T = u2, S = u2 + a2; T < S; T++)
                (l2 = i2[T]).operating[e3.mode] = true, l2.queue[e3.mode].unshift(e3), e3.prior && (delete l2.bookId[e3.mode], t3.logger && t3.logger.info(T + "号轨道恢复正常使用")), l2.operating[e3.mode] = false;
              if (e3.prior) {
            ...
            if (e3.options.realTime) {
              ...
              if (t3.danmu.bulletBtn.main.queue.forEach(function(e4, n3) {
                ...
                for (var D = P.channel_id[0], I = P.channel_id[0] + P.channel_id[1]; D < I; D++)
            ...
            if (e3.prior)
              if (e3.bookChannelId || t3.danmu.live) {
                ...
                if (-1 !== u2) {
                  for (var B = u2; B < u2 + a2; B++)
                    i2[B].bookId[e3.mode] = e3.id, t3.logger && t3.logger.info(B + "号轨道被" + e3.id + "号优先弹幕预定");
                  if (n2.player)
                    n2.bulletBtn.main.data.some(function(n3) {
            ...
            for (var t3 = this.channels, n2 = e3.channel_id, i2 = void 0, r2 = n2[0], o2 = n2[0] + n2[1]; r2 < o2; r2++)
              if (i2 = t3[r2]) {
            ...
            if (this.danmu && this.danmu.config) {
              ...
              if (e3.area) {
                ...
                if ((0, l.validAreaLineRule)(r2))
                  n2 = r2, "b2t" === this.direction ? this.width = n2 * t3 : this.height = n2 * t3;
                else if (o2 >= 0 && a2 >= o2) {
                  var u2 = a2 - o2;
              ...
              for (var c = [], f = 0; f < n2; f++)
                c[f] = { id: f, queue: { scroll: [], top: [], bottom: [] }, operating: { scroll: false, top: false, bottom: false }, bookId: {} };
            ...
            function i2(e4, i3) {
              ...
              for (var a2 = 0; a2 < t3.channels.length; a2++)
                n2(e4, a2), r3(a2), o3(a2);
        ...
        var o = function() {
          ...
          return i(e2, [{ key: "init", value: function(e3) {
            ...
            for (var n2 in this)
              r.hasOwnProperty.call(this, n2) && delete this[n2];
        ...
        var o = new (function() {
          ...
          return i(e2, [{ key: "addObserver", value: function(e3, t2) {
            if (this.observer && e3) {
              ...
              for (var n2 = this.__handlers, i2 = -1, r2 = 0; r2 < n2.length; r2++)
                n2[r2] && e3 === n2[r2].target && (i2 = r2);
          ...
          for (var n2 = 0; n2 < e2.length; n2++) {
            ...
            if (r2) {
              ...
              for (var a2 = 0; a2 < r2.parts.length; a2++)
                r2.parts[a2](i2.parts[a2]);
              for (; a2 < i2.parts.length; a2++)
                r2.parts.push(b(i2.parts[a2], t2));
            } else {
              var s2 = [];
...
export {
  ...
  DefaultPreset,
  PresetPlayer,
  DefaultPreset3 as DefaultPreset2,
  DefaultPreset4 as DefaultPreset3,
  DefaultPreset5 as DefaultPreset4,
  zhHk,
  jp,
  DanmuPanel,
  DanmuIcon,
...
*/
//# sourceMappingURL=chunk-XZQZDOFT.js.map
